...
#define STRING_CONFIG_H_AUTHOR "(gausnes, default config)" // Who made the changes.
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80,80,400,143}  // default steps per unit for Ultimaker
